...
public class DataBase_OLD {
    ...
    public HashMap<String, Person_OLD> people = new HashMap<>();
    ...
    private HashMap<String, Person_OLD> loadPeopleIntoArray() {
        HashMap<String, Person_OLD> returner = new HashMap<>();
        try {
            ...
            for (Object key : data.keySet()) {
                ...
                returner.put(keyStr, new Person_OLD((JSONObject) keyvalue));
            }
        } catch (Exception e) {
    ...
    public HashMap<String, Person_OLD> getPeople() {
        if (cacheData) {
            return this.people;
        } else {
    ...
    public void reloadAndAdd(Person_OLD person) {
        if (cacheData) {
            this.people.put(person.getCardID(), person);
        }
    }
